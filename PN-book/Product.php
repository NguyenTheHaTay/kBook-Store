    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" style="padding: 1px;"><img alt="Brand" src="img/logo2.png" style="width: 147px; margin: 0px;"></a>
        </div>
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Tìm kiếm sách,tác giả hoặc thể loại" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:rgb(228, 55, 25);text-transform:uppercase;margin-bottom:0px;"> '. $category .' 
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
                  <div class="col-sm-5 col-sm-offset-6 col-md-5 col-md-offset-7 col-lg-4 col-lg-offset-8">
                       <form action="';echo $_SERVER['PHP_SELF'];echo'" method="post" class="pull-right">
                           <label for="sort">Lựa chọn tìm kiếm &nbsp: &nbsp</label>
                            <select name="sort" id="select" onchange="form.submit()">
                                ...
                                <option value="priceh" name="priceh">Giá từ cao đên thấp </option>
                                <option value="discountl" name="discountl">Giảm giá từ cao đên thấp </option>
                                <option value="discount" name="discount">Giảm giá từ thấp đến cao</option>
                            </select>
                       </form>
                  </div>
              </div>
            ...
            echo'<a href="'.$description.'">
                <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                    <div class="book-block" style="border :3px solid #DEEAEE;">
                        ...
                        <hr>
                         ' . $row["Title"] . '<br>
                        ' .number_format($row['Price'],3).' VND  &nbsp
